...
import { createContext, useRef, useContext, useMemo, useEffect, useInsertionEffect, useLayoutEffect, useDebugValue, forwardRef, createElement } from 'react';
...
function getUseInsertionEffect(isSSR) {
  return isSSR ? useEffect : useInsertionEffect || // React 18+ (https://github.com/reactwg/react-18/discussions/110)
  useLayoutEffect;
}
